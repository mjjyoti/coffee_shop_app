import 'package:coffee_shop_app/item_model.dart';
...
class _CoffeeHomeState extends State<CoffeeHome> {
                  ...
                  children: <Widget>[
                    Expanded(
                      ...
                      child: Container(
                        ...
                        padding:
                            const EdgeInsets.only(left: 24, right: 24, top: 61),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            const Icon(Icons.add, color: Colors.white, size: 29)
                          ],
                        ),
                      ),
                    ),
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    ...
                    maxLines: 1,
                    style:
                        const TextStyle(color: Color(0xFF56463b), fontSize: 25),
                  ),
                  ...
                  Text(
                    ...
                    maxLines: 1,
                    style: const TextStyle(
                        color: Color(0xFFc8b7af), fontSize: 20.5),
                  ),
                ],
              ),
            ),
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        backgroundColor: const Color(0xFF624639),
        body: Container(
          child: Stack(
            children: <Widget>[
              Container(
